...
namespace ViperOps2MIZ.Utility.LsonLib
{
    // using Private;
    ...
    [Serializable]
    public partial class LsonParseException : Exception
    {
    ...
    class LsonParserState
    {
        ...
        public char? Cur { get { return Pos >= Lson.Length ? null : Lson[Pos]; } }
    ...
    public abstract class LsonValue : DynamicObject, IEquatable<LsonValue>
    {
        ...
        public static explicit operator string(LsonValue value) { return value == null ? null : value.GetString(); }
        ...
        /// <summary>See <see cref="BoolConversionOptions.Strict"/>.</summary>
        public static explicit operator bool?(LsonValue value) { return value == null ? null : value.GetBool(); }
        ...
        /// <summary>See <see cref="NumericConversionOptions.Strict"/>.</summary>
        public static explicit operator double?(LsonValue value) { return value == null ? null : value.GetDouble(); }
        /// <summary>See <see cref="NumericConversionOptions.Strict"/>.</summary>
        public static explicit operator decimal(LsonValue value) { return value.GetDecimal(); }
        /// <summary>See <see cref="NumericConversionOptions.Strict"/>.</summary>
        public static explicit operator decimal?(LsonValue value) { return value == null ? null : value.GetDecimal(); }
        /// <summary>See <see cref="NumericConversionOptions.Strict"/>.</summary>
        public static explicit operator long(LsonValue value) { return value.GetLong(); }
        /// <summary>See <see cref="NumericConversionOptions.Strict"/>.</summary>
        public static explicit operator long?(LsonValue value) { return value == null ? null : value.GetLong(); }
        /// <summary>See <see cref="NumericConversionOptions.Strict"/>.</summary>
        public static explicit operator int(LsonValue value) { return value.GetInt(); }
        /// <summary>See <see cref="NumericConversionOptions.Strict"/>.</summary>
        public static explicit operator int?(LsonValue value) { return value == null ? null : value.GetInt(); }
    ...
    public sealed class LsonDict : LsonValue, IDictionary<LsonValue, LsonValue>, IEquatable<LsonDict>
    {
        ...
        public override IEnumerable<string> ToEnumerable()
        {
            ...
            foreach (var kvp in Dict)
            {
                if (!first)
                    yield return ",";
                foreach (var piece in ToEnumerable(kvp.Key))
                    yield return piece;
                yield return ":";
                foreach (var piece in ToEnumerable(kvp.Value))
                    yield return piece;
                first = false;
            }
            yield return "}";
        ...
        public override void AppendIndented(StringBuilder sb, int indentation = 0)
        {
            ...
            foreach (var kvp in Dict)
            {
                ...
                {
                    AppendIndented(kvp.Value, sb, indentation + 1);
                    sb.Append(',');
                ...
                else
                {
                    implicitIndex = -1;
                    sb.Append('[');
                    AppendIndented(kvp.Key, sb, indentation + 1);
                    sb.Append("] = ");
                    AppendIndented(kvp.Value, sb, indentation + 1);
                    sb.Append(',');
                }
    ...
    public sealed class LsonString : LsonValue, IEquatable<LsonString>
    {
        ...
        protected override decimal? getDecimal(NumericConversionOptions options, bool safe)
        {
            ...
            decimal result;
            return decimal.TryParse(_value, NumberStyles.Number, CultureInfo.InvariantCulture, out result) ? result : null;
        }
        ...
        protected override int? getInt(NumericConversionOptions options, bool safe)
        {
            ...
            if (!options.HasFlag(NumericConversionOptions.AllowZeroFractionToInteger))
            {
                ...
                int result;
                return int.TryParse(_value, NumberStyles.Integer, CultureInfo.InvariantCulture, out result) ? result : null;
            }
            else
            {
                decimal result;
        ...
        protected override long? getLong(NumericConversionOptions options, bool safe)
        {
            ...
            if (!options.HasFlag(NumericConversionOptions.AllowZeroFractionToInteger))
            {
                ...
                long result;
                return long.TryParse(_value, NumberStyles.Integer, CultureInfo.InvariantCulture, out result) ? result : null;
            }
            else
            {
                decimal result;
    ...
    public sealed class LsonBool : LsonValue, IEquatable<LsonBool>
    {
        ...
        public static implicit operator bool?(LsonBool value) { return value == null ? null : value._value; }
    ...
    public sealed class LsonNumber : LsonValue, IEquatable<LsonNumber>
    {
        ...
        public static explicit operator double(LsonNumber value) { return double.IsNaN(value._double) ? value._long : value._double; }
        /// <summary>Converts the specified <see cref="LsonNumber"/> to a nullable double.</summary>
        public static implicit operator double?(LsonNumber value) { return value == null ? null : double.IsNaN(value._double) ? value._long : value._double; }
        ...
        public static explicit operator decimal(LsonNumber value) { return double.IsNaN(value._double) ? value._long : (decimal)value._double; }
        /// <summary>
        ///     Converts the specified <see cref="LsonNumber"/> to a nullable decimal. This operator is slightly lossy; see
        ///     Remarks on <see cref="LsonNumber"/>.</summary>
        public static explicit operator decimal?(LsonNumber value) { return value == null ? null : (decimal)value; }
        ...
        ///     cref="NumericConversionOptions.Strict"/>.</summary>
        public static explicit operator long?(LsonNumber value) { return value == null ? null : (long)value; }
        ...
        ///     cref="NumericConversionOptions.Strict"/>.</summary>
        public static explicit operator int?(LsonNumber value) { return value == null ? null : (int)value; }
        ...
        public object RawValue { get { return double.IsNaN(_double) ? _long : (object)_double; } }
        ...
        {
            if (other == null) return false;
            if (double.IsNaN(_double) && double.IsNaN(other._double))
    ...
    public sealed class LsonNoValue : LsonValue
    {
        ...
        /// <summary>See <see cref="LsonValue.ToEnumerable()"/>.</summary>
        public override IEnumerable<string> ToEnumerable() { return ToEnumerable(null); }

        /// <summary>Converts the current LSON value to a LSON string that parses back to this value.</summary>
        public override void AppendIndented(StringBuilder sb, int indentation = 0) { AppendIndented(null, sb, indentation); }
